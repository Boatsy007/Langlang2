...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    const safeMotorcycle = escapeHtml(motorcycle || 'Not specified')
    const safeMessage = escapeHtml(message).replace(/\n/g, '<br>')

    // Email to Lang Restorations
          ...
          <div style="max-width:720px;margin:0 auto;padding:30px 18px;">
            ...
            <div style="border:1px solid #242424;background:#0a0a0a;padding:38px 34px;box-shadow:0 20px 60px rgba(0,0,0,0.45);">
              ...
              <table style="width:100%;border-collapse:collapse;margin-bottom:30px;">
                ...
                <tr>
                  <td style="padding:15px 0;border-bottom:1px solid #222;color:#777;font-size:11px;font-weight:800;letter-spacing:2px;text-transform:uppercase;">Phone</td>
                  <td style="padding:15px 0;border-bottom:1px solid #222;color:#ffffff;font-size:15px;font-weight:700;">${safePhone}</td>
                </tr>
                <tr>
                  <td style="padding:15px 0;border-bottom:1px solid #222;color:#777;font-size:11px;font-weight:800;letter-spacing:2px;text-transform:uppercase;">Motorcycle</td>
                  <td style="padding:15px 0;border-bottom:1px solid #222;color:#ffffff;font-size:15px;font-weight:700;">${safeMotorcycle}</td>
                </tr>
              </table>
            ...
            <div style="border:1px solid #242424;background:#0a0a0a;padding:40px 34px;box-shadow:0 20px 60px rgba(0,0,0,0.45);">
              ...
              <div style="background:#111;border:1px solid #262626;padding:24px;margin:0 0 30px;">
                ...
                <p style="margin:0 0 12px;color:#ffffff;font-size:15px;">
                  <strong>Motorcycle:</strong> ${safeMotorcycle}
                </p>
                <p style="margin:0 0 12px;color:#ffffff;font-size:15px;">
